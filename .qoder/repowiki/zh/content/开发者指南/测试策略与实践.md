...
## 结论
通过 Storybook 与 Vitest 的结合，智言万象 项目可以建立从可视化到可重复的测试体系：以 Storybook 验证组件外观与交互，以 Vitest 保证行为与状态的稳定性。配合 @nuxt/test-utils 与 @vue/test-utils，能够在 Nuxt/Vue 生态中高效开展组件测试。将测试纳入 CI/CD，可显著提升重构安全性与交付质量。
