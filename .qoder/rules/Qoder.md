...
> 本文档定义了 BuidAI 项目的开发规范、代码标准和最佳实践，所有开发者必须遵循这些规则以确保代码质量和团队协作效率。
...
links:
  - label: 'GitHub'
    ...
    to: 'https://github.com/buidai'
    target: '_blank'
---

# 快速开始

本指南将帮助您快速开始使用 BuidAI。
...
- 📖 查看 [完整文档](./BuidAI.md)
- 🐛 [提交 Issue](https://github.com/buidai/issues)
- 💬 [加入讨论](https://github.com/buidai/discussions)
