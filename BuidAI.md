...
智言万象（智言AI）是一个面向企业级 AI 应用开发平台的官网模板项目，专为以下用户群体设计：
...
|------|---------|------|
| `/` | `pages/index.vue` | 首页 |
| `/agent` | `pages/agent.vue` | 智言AI产品页 |
| `/智言万象` | `pages/智言万象.vue` | 私有部署方案 |
...
<template>
  ...
  <!-- 图片添加 alt 属性 -->
  <img src="/logo.svg" alt="智言万象 Logo" />
...
- **官网**: https://智言万象.com
- **文档**: https://docs.智言万象.com
- **GitHub**: https://github.com/智言万象
- **邮箱**: contact@智言万象.com
