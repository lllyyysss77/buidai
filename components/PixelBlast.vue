<template>
  <div ref="container" class="w-full h-full relative overflow-hidden" aria-label="PixelBlast interactive background">
...
const initThree = () => {
  ...
  if (threeRef) {
    ...
    if (t.renderer.domElement.parentElement === container.value) {
      container.value.removeChild(t.renderer.domElement)
    }
    threeRef = null
  }
