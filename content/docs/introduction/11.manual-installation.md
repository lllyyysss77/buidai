...
::code-group
```bash [Gitee仓库]
git clone https://gitee.com/BidingCC/buidAI.git
```

```bash [Github仓库]
git clone https://github.com/BidingCC/buidAI.git
```
::
...
::code-group
```bash [单独启动server]
cd /buidAI/packages/api
pnpm dev
```

```bash [单独启动web]
cd /buidAI/packages/web/buidAI-ui
pnpm dev
```
::
