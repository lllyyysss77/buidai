...
useSeoMeta({
  ...
  ogType: product.seo.ogType,
  twitterCard: product.seo.twitterCard,
...
// 功能详情（保持响应式以便 hover 交互）
const featureDetails = ref(
  product.featureDetails.map((d) => ({ ...d, activePoint: 0 }))
)
      ...
      <div class="container mx-auto px-4 text-center relative z-10">
        <div class="flex flex-col gap-6 items-center max-w-4xl mx-auto">
          <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-50 border border-gray-200 dark:bg-gray-800 dark:border-gray-700 mb-4">
            ...
            <span class="text-xs text-gray-600 dark:text-gray-300">{{ product.hero.badge }}</span>
          </div>
          ...
          <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 dark:text-white leading-tight">
            {{ product.hero.h1Leading }}<span class="text-ui-primary">{{ product.hero.h1Highlight }}</span>{{ product.hero.h1Suffix || '' }}
          </h1>

          <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed" v-html="product.hero.description" />
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 max-w-3xl mx-auto">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            {{ product.featuresGrid.title }}
          </h2>
          <p class="text-gray-500 dark:text-gray-400 text-lg">
            {{ product.featuresGrid.description }}
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p class="text-gray-500 dark:text-gray-400 leading-relaxed">{{ feature.desc }}</p>
          </div>
        </div>
      </div>
    </div>
