    ...
    <section class="relative pt-24 pb-12 md:pt-32 md:pb-16 overflow-hidden text-center">
      ...
      <div class="relative z-10 container mx-auto px-4 flex flex-col items-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 md:mb-24 w-full sm:w-auto px-4 sm:px-0">
          <button class="w-full sm:w-auto group relative px-8 py-3.5 rounded-full bg-gradient-to-r from-[#6E58FF] to-[#7A42FF] text-white font-semibold text-[15px] shadow-[0_8px_20px_-4px_rgba(110,88,255,0.4)] hover:shadow-[0_12px_24px_-6px_rgba(110,88,255,0.5)] active:scale-95 transition-all duration-300 touch-manipulation">
            立即体验
        ...
        <div class="relative w-full max-w-5xl h-[260px] md:h-[340px] perspective-1000">
          <div class="absolute inset-x-0 bottom-0 h-full flex justify-center items-end">
             ...
             <!-- 左侧卡片（内层） -->
             <div class="absolute left-1/2 -translate-x-[100%] md:-translate-x-[110%] bottom-0 w-[180px] h-[200px] md:w-[320px] md:h-[340px] bg-[#1E1E2E] rounded-2xl shadow-xl z-20 transform rotate-[-6deg] hover:rotate-[-8deg] transition-transform duration-500 overflow-hidden border border-gray-800">
             ...
             <!-- 左侧卡片（外层） -->
             <div class="hidden lg:block absolute left-1/2 -translate-x-[180%] bottom-4 w-[220px] md:w-[300px] h-[240px] md:h-[320px] bg-white rounded-2xl shadow-lg z-10 transform rotate-[-12deg] hover:rotate-[-14deg] transition-transform duration-500 border border-gray-200 overflow-hidden">
             ...
             <!-- 右侧卡片（内层） -->
             <div class="absolute left-1/2 translate-x-[0%] md:translate-x-[10%] bottom-0 w-[180px] h-[200px] md:w-[320px] md:h-[340px] bg-gradient-to-br from-[#E0E7FF] to-[#F3E8FF] rounded-2xl shadow-xl z-20 transform rotate-[6deg] hover:rotate-[8deg] transition-transform duration-500 border border-white/50">
             ...
             <!-- 右侧卡片（外层） -->
             <div class="hidden lg:block absolute left-1/2 translate-x-[80%] bottom-4 w-[220px] md:w-[300px] h-[240px] md:h-[320px] bg-[#0F0F12] rounded-2xl shadow-lg z-10 transform rotate-[12deg] hover:rotate-[14deg] transition-transform duration-500 border border-gray-800 overflow-hidden">
        ...
        <div class="text-center mb-12">
          ...
          <div class="inline-flex items-center p-1.5 bg-[#F5F6FA] rounded-full overflow-x-auto max-w-full touch-manipulation no-scrollbar">
            <button
              ...
              :class="[
                'px-4 md:px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap flex-shrink-0',
                currentTab === tab
